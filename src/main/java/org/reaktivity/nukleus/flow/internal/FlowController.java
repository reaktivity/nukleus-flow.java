...
import org.reaktivity.nukleus.flow.internal.types.Flyweight;
import org.reaktivity.nukleus.flow.internal.types.OctetsFW;
import org.reaktivity.nukleus.flow.internal.types.control.FreezeFW;
import org.reaktivity.nukleus.flow.internal.types.control.Role;
import org.reaktivity.nukleus.flow.internal.types.control.RouteFW;
import org.reaktivity.nukleus.flow.internal.types.control.UnrouteFW;
import org.reaktivity.nukleus.route.RouteKind;

public final class FlowController implements Controller
{
    ...
    {
        return route(RouteKind.PROXY, localAddress, remoteAddress);
    }
